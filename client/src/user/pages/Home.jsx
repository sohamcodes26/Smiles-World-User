...
export default function Home() {
  ...
  return (
    <>
      {/* This hero section remains unchanged as it has a different background */}
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.p
                className="text-2xl md:text-4xl text-white/80 all-text-color font-normal"
      ...
      <div className="bg-[#05143c] all-bg-color">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white all-text-color mb-4">
                ✨ Featured Travel Packages
              </h2>
              <p className="text-xl text-white all-text-color font-light max-w-3xl mx-auto">
